 ...
 * @returns JSX.Element
 */
export default function Graph({ api, mode = "edit", onError, panButton = 1, snapGrid, getMoveGroup }: GraphProps) {
    ...
    const handleMouseDown = useCallback((ev: React.MouseEvent<HTMLDivElement>) => {
        ...
        // Shift+arraste é reservado ao consumidor (ex.: seleção de
        // área); não iniciamos pan nesse caso.
